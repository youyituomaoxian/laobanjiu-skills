...
{
  const ALLOW = new Set([
    // 预设 A · hot-analysis 深藏蓝紫
    '#0b0f19', '#131a2b', '#1a2339', '#1e2d4a', '#16203a', '#e2e8f0', '#94a3b8',
    '#64748b', '#a78bfa', '#38bdf8', '#34d399', '#f87171', '#fb923c', '#fbbf24',
    '#334155', '#243352',
    // 预设 B · shadcn Zinc
    '#09090b', '#18181b', '#141417', '#27272a', '#fafafa', '#a1a1aa', '#71717a',
    '#3b82f6', '#06b6d4', '#8b5cf6', '#f97316', '#eab308',
    // 中性 / 打印
